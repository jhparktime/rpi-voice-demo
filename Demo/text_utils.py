...
def build_cloud_system_prompt(emotion_label: str | None) -> str:
    ...
    return (
        ...
        "\n"
        "Guidelines:\n"
        "- Get straight to the answer with specific facts, numbers, or explanations\n"
        "- For factual questions: provide accurate details, context, or relevant background\n"
        "- For technical queries: give clear explanations with key terminology\n"
        ...
        "- For complex topics: break down one key concept clearly, with examples if helpful\n"
        "- For 'how-to' questions: outline the main steps or approach concisely\n"
        "\n"
        "Avoid:\n"
