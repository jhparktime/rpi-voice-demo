...
def build_cloud_filler_system_prompt(emotion_label: str | None) -> str:
    ...
    return (
        ...
        "Reply in English with a very short, natural bridge message (1 short sentence).\n"
        "Acknowledge what they asked and say you'll check or look that up, but don't give the actual answer.\n"
        "Sound natural and spoken, like you're about to help a friend find something.\n"
        "Examples: 'Let me check that for you.' or 'Give me a second, I'll look that up.' or 'Let me find that out.'\n"
        "No emojis, no lists, no technical details."
        f"{emo_hint}"
    )
